...
![EDA Project Overview](https://github.com/lukebarousse/SQL_Data_Engineering_Course/raw/main/Resources/images/1_1_Project1_EDA.png)

A SQL project analyzing the data science job market using real world job posting data. It demonstrates my ability to **write production-quality analytical SQL, design efficient queries, and turn business questions into data-driven insights**.
...
![Data Warehouse Schema](https://github.com/lukebarousse/SQL_Data_Engineering_Course/raw/main/Resources/images/1_2_Data_Warehouse.png)
...
1. **[Top Demanded Skills](./01_top_demanded_skills.sql)** – Identifies the 10 most in-demand skills in the data science job market in sri lanka
2. **[Top Paying Skills](./02_top_paying_skills.sql)** – Analyzes the top 10 highest-paying skills with salary and demand metrics
